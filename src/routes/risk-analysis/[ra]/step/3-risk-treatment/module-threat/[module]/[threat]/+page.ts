...
export const load: PageLoad = async ({ fetch, params }) => {
    const [treatmentRes, linkedRes, allMeasuresRes] = await Promise.all([
        fetch(`/svc/risk-analysis/module-threat-risk-treatment/${params.ra}/${params.module}/${params.threat}`),
        fetch(`/svc/risk-analysis/module-threat-risk-treatment-measures/${params.ra}/${params.module}/${params.threat}`),
