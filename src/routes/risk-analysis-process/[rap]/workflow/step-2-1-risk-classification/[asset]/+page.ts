...
import { SVC_ASSET_GET, SVC_ENUM_BSI_IT_GRUNDSHUTZ_ELEMENTARY_THREAT_LIST, SVC_ENUM_FREQUNCY_OF_OCCURRENCE_LIST, SVC_ENUM_POTENTIAL_DAMAGE_LIST, SVC_ENUM_POTENTIAL_RISK_LIST, SVC_ENUM_PROTECTION_NEEDS_LIST } from '$lib/routes';
